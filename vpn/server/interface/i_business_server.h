...
public:
    virtual vpn_channel_info * create_channel_server(int client_id, const char * out_ip, int out_port, const char * in_ip, int in_port, const char * local_ip, int local_port)=0;
